        ...
        <div class="block1">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 R1">
                <div class="form-group">
                  <select name="subjectt" class="form-control" id="subjectt">
                    <option value="">-- Matière --</option>
                  </select>
                </div>
              </div>

              <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 R2">
                <div class="form-group">
                  <select name="proff" class="form-control" id="proff">
              ...
              <div class="checkbox">
                <label><input type="checkbox" value="all">Tous les groupes</label>
              </div>
            </div>
          </div>
        </div><!--block1--> 
